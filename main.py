    ...
    try:
        ...
        if cloudtype == 'moodle':
            ...
            if loged:
                ...
                bot.editMessageText(message,'✖️🌐 ERROR AL CONECTAR CON LA NUBE 🌐✖️')
...
def processFile(update,bot,message,file,thread=None,jdb=None):
    ...
    if file_size > max_file_size:
        ...
        file_upload_count = 1
    bot.editMessageText(message,'📝Preparando Archivo⚡️...')
    evidname = ''
    files = []
    if client:
...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/add' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.save()
                    msg = '👤Ahora @'+user+' tiene acceso a FastZone como [USUARIO]'
        ...
        if '/admin' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.save()
                    msg = '👑Ahora @'+user+' tiene acceso a FastZone como [ADMIN]'
                    bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/prueba' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.save()
                    msg = '👤Ahora @'+user+' tiene acceso a FastZone en [MODO PRUEBA]'
                    bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/ban' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.remove(user)
                    jdb.save()
                    msg = '❌El usuario '+user+' ha sido expulsado de FastZone🚫'
                    bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/commands' in msgText:
            message = bot.sendMessage(update.message.chat.id,'🙂Para añadir estos comandos al menú de acceso rápido debe enviarle el comando /setcommands a @BotFather y luego seleccionar su bot, luego solo queda reenviarle el mensaje con los siguientes comandos y Listo😃.')
        ...
        if '/start' in msgText:
            ...
            start_msg+= '🆚Version del Bot: GOLD EDITION\n'
            start_msg+= '✅BIENVENIDO✅🔱Estas usando #FastZone el bot para subir y descargar de la nube sin consumo de MB.\n'
            ...
            start_msg+= '🌀Que disfrute su estadia en FastZone⚡\n'
            ...
            message = bot.sendMessage(update.message.chat.id,'🦾')
             ...
             if loged:
                 ...
                 client.logout()
                 bot.editMessageText(message,'TXT 𝙰𝚚𝚞𝚒👇')
             else:
            ...
            if loged:
                ...
                client.logout()
                bot.editMessageText(message,'Archivo 𝚎𝚕𝚒𝚖𝚒𝚗𝚊𝚍𝚘🗑️')
            else:
                bot.editMessageText(message,'🧐')
                message = bot.sendMessage(update.message.chat.id,'⚠️Error y posibles causas:\n1-Revise su Cuenta\n2-Servidor Desabilitado: '+client.path)
        elif '/del_' in msgText and user_info['cloudtype']=='moodle':
            ...
            if loged:
                ...
                client.logout()
                bot.editMessageText(message,'Archivos 𝚎𝚕𝚒𝚖𝚒𝚗𝚊𝚍𝚘𝚜🗑️')
            else:
                bot.editMessageText(message,'🧐')
                message = bot.sendMessage(update.message.chat.id,'⚠️Error y posibles causas:\n1-Revise su Cuenta\n2-Servidor Desabilitado: '+client.path)
            ...
            #    
                # set in debug
            #    api_id = 14921549
            #    api_hash = '631645d79c0bfffb669b08fec9084b2f'
            #    bot_token = '5431980790:AAEAWVqGNsHYGdnGyNgzvKMffdzoLqjJO1I'
            ...
            #    return
            bot.editMessageText(message,'⚠️Error, No se pudo analizar correctamente⚠️')
    except Exception as ex:
           print(str(ex))
